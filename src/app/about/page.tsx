export default function AboutPage() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-[#fdf3ec] gap-6 p-4">
      <section className="bg-white rounded-xl shadow-lg p-8 max-w-xl w-full transition-transform transform hover:scale-105 hover:shadow-2xl duration-300">
        <div className="flex items-center">
          <div className="flex-1">
            <span className="text-3xl mr-3">👩‍💻</span>
            <h1 className="text-2xl font-bold text-[#666699] mb-4">
              Lee SungHye
            </h1>
          ...
          <img
            src="/images/bingti2.png"
            alt="Bingti"
            className="w-56 h-56 rounded-full object-cover ml-6"
          />
        </div>
      </section>
